...
window.addEventListener('DOMContentLoaded', () => {
  ...
  loadData(listId, submitButton)
  if (addItemForm) {
    addItemForm.addEventListener('submit', (e) => {
      addOrUpdateItem(e, listId, submitButton)
    })
  }
})

function appendAndAddEventListenersToElements(container, filter, list, clearButton, submitButton) {
  ...
  list.addEventListener('click', (e) => {
    prepareUpdateItem(e, submitButton)
  })
...
function addOrUpdateItem(e, listId, submitButton) {
  e.preventDefault()
  ...
  if (inputItem) {
    if (!isUpdate) {
      ...
      addItem(text, SHOPPING_LIST, listId)
    } else {
      // Update an item
      ...
      editedItem.appendChild(document.createTextNode(inputItem.value.trim()))
      editedItem.appendChild(createButton('remove-item btn-link red-text'))
...
function addItem(text, shoppingList, listId) {
...
function createList(id, shoppingList) {
...
// Update item
function prepareUpdateItem(e, submitButton) {
